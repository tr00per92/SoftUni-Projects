...
public class exam5_04 {
	...
	public static void main(String[] args) {
		...
		for (LocalDate i = start;  i.isBefore(end); i=i.plusDays(1)) {
			...
			int i8 = i.getYear() % 10;
			int sum = i1 * (i2+i3+i4+i5+i6+i7+i8) + i2 * (i3+i4+i5+i6+i7+i8) + i3 * (i4+i5+i6+i7+i8) +
					i4 * (i5+i6+i7+i8) + i5 * (i6+i7+i8) + i6 * (i7+i8) + i7 * i8;
			if (sum == target) {
				System.out.println(i.format(DateTimeFormatter.ofPattern("dd-MM-yyyy")));
				no = false;
			}
		}
		if (no) {
