namespace LongestIncreasingSubsequence.Tests
{
    ...
    public class LongestIncreasingSubsequenceTests
    {
        ...
        public void Test6Numbers()
        {
            ...
            CollectionAssert.AreEqual(expectedSeq, actualSeq.ToArray());
        }
        ...
        public void Test11Numbers()
        {
            ...
            var expectedSeq = new[] { 3, 5, 7, 8, 9, 11 };
            var actualSeq = LongestIncreasingSubsequence.FindLongestIncreasingSubsequence(sequence);
            CollectionAssert.AreEqual(expectedSeq, actualSeq.ToArray());
        }
        ...
        {
            var sequence = new[] { 1, 1, 1 };
            var expectedSeq = new[] { 1 };
            var actualSeq = LongestIncreasingSubsequence.FindLongestIncreasingSubsequence(sequence);
            CollectionAssert.AreEqual(expectedSeq, actualSeq.ToArray());
        }
        ...
        public void TestPerformance5000Numbers()
        {
            ...
            sequence[4999] = 0;
            var actualSeq = LongestIncreasingSubsequence.FindLongestIncreasingSubsequence(sequence);
            Assert.AreEqual(4997, actualSeq.Count);
        }
    }
}