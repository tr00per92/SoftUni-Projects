...
public class Assertions
{
    ...
    {
        Debug.Assert(value != null, "The serch value cannot be null");
    ...
    {
        Debug.Assert(arr != null, "The array is null");
        Debug.Assert(startIndex >= 0, "The start index must be positive");
        Debug.Assert(startIndex <= arr.Length - 1, "The start index is outside the array");
        Debug.Assert(endIndex >= 0, "The end index must be postive");
        Debug.Assert(endIndex <= arr.Length - 1, "The end index is outside the array");
        Debug.Assert(startIndex <= endIndex, "The start index cannot be greater than the end index");
