namespace SportSystem.Data.Migrations
{
    ...
    public sealed class DefaultConfiguration : DbMigrationsConfiguration<SportSystemDbContext>
    {
        ...
        private void LoadMatches(SportSystemDbContext context, IList<Team> teams)
        {
        ...
        private void LoadPlayers(SportSystemDbContext context, IList<Team> teams)
        {
            var players = new List<Player>()
            {
                new Player() { Name = "Alexis Sanchez", TeamId = teams[2].Id, DateOfBirth = new DateTime(1982, 1, 3), Height = 1.65m },
                new Player() { Name = "Arjen Robben", TeamId = teams[1].Id, DateOfBirth = new DateTime(1982, 1, 3), Height = 1.65m },
                new Player() { Name = "Franck Ribery", TeamId = teams[0].Id, DateOfBirth = new DateTime(1982, 1, 3), Height = 1.65m },
                new Player() { Name = "Wayne Rooney", TeamId = teams[0].Id, DateOfBirth = new DateTime(1982, 1, 3), Height = 1.65m },
                new Player() { Name = "Lionel Messi", DateOfBirth = new DateTime(1982, 1, 13), Height = 1.65m },
                new Player() { Name = "Theo Walcott", DateOfBirth = new DateTime(1983, 2, 17), Height = 1.75m },
                new Player() { Name = "Cristiano Ronaldo", DateOfBirth = new DateTime(1984, 3, 16), Height = 1.85m },
                new Player() { Name = "Aaron Lennon", DateOfBirth = new DateTime(1985, 4, 15), Height = 1.95m },
                new Player() { Name = "Gareth Bale", DateOfBirth = new DateTime(1986, 5, 14), Height = 1.90m },
                new Player() { Name = "Antonio Valencia", DateOfBirth = new DateTime(1987, 5, 23), Height = 1.82m },
                new Player() { Name = "Robin van Persie", DateOfBirth = new DateTime(1988, 6, 13), Height = 1.84m },
                new Player() { Name = "Ronaldinho", DateOfBirth = new DateTime(1989, 7, 30), Height = 1.87m },
            };
