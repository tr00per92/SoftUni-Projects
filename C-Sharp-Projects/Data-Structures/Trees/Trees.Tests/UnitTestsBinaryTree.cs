namespace Trees.Tests
{
    ...
    {
        [TestMethod]
        public void BuildBinaryTreeForEachTraversalInOrderShouldWorkCorrectly()
        {
            // Arrange
            var binaryTree =
        ...
        [TestMethod]
        public void BuildBinaryTreeForEachTraversalPostOrderShouldWorkCorrectly()
        {
            // Arrange
            var binaryTree =
                new BinaryTree<string>("*",
        ...
        [TestMethod]
        public void BuildBinaryTreePrintIndentedPreOrderShouldWorkCorrectly()
        {
            // Arrange
            var binaryTree =
                new BinaryTree<string>("*",
